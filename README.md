...
| 11 | Networks with D3.js — NetworkX→D3.js, force layouts, interactivity, encoding & community hulls, rendering & scale, Web Workers, capstone | | [tutorials/11-networks-d3js/](dataviz/tutorials/11-networks-d3js/index.html) — 7 long-form tutorials (11a–11g) + 18 self-contained examples |
| 12 | Advanced Network Visualization — Adjacency Matrix, Chord, Sankey, Edge Bundling, Dynamic & Streaming Graphs, Beyond-D3 Ecosystem, Capstone | | [tutorials/12-advanced-network-viz/](dataviz/tutorials/12-advanced-network-viz/index.html) — 7 long-form tutorials (12a–12g) + 9 self-contained examples |
